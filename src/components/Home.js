  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-200">
      ...
      <header className="w-full bg-white shadow-md fixed top-0 left-0 z-10 py-6 px-4">
        <h1 className="text-2xl font-bold text-center text-gray-800 mt-4">Home</h1>
      </header>
      ...
      <div className="flex flex-grow items-center justify-center p-4 text-center mt-20">
        <div>
          <h2 className="text-xl font-semibold text-gray-700">Welcome to your Dashboard</h2>
          <p className="text-gray-600">Here you can see your notifications, goals, and general overview.</p>
        </div>
      </div>
